...
function getDefaultRiskDomains(domain, category) {
...
function mapRequirementTypeToSeverity(requirementType) {
...
function extractCanonicalName(content) {
...
function extractApplicability(content) {
...
function extractControlReference(content) {
...
function extractOverviewTable(content) {
  const result = {};
...
function parseReadmeToSignalJson(readmePath) {
  try {
...
function findSignalsWithoutJson(signalsPath) {
  const results = [];
...
// Main function
async function generateSignalJsonFiles() {
